...
class Shumlib(MakefilePackage):
    ...
    version("um13.0", sha256="50f43a2f8980e8fbeafd053376612503bcb17c34948297f19b2c95ce0642b340",
    url = "https://github.com/metomi/shumlib/archive/refs/tags/um13.0.tar.gz")

    def edit(self, spec, prefix):
        env['PLATFORM'] = 'spack'
        env['FPP'] = 'cpp'
        env['FPPFLAGS'] = '-C -P -undef -nostdinc -DEVAL_NAN_BY_BITS -DEVAL_DENORMAL_BY_BITS'
